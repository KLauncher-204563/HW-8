...
let wotEr = prompt("Виберіть напій: Кава, Чай або Сік");
...
let day = prompt("Введіть день тижня (наприклад: понеділок, вівторок, середа, четвер, п'ятниця, субота, неділя)").toLowerCase();
...
let nomer  = prompt("Введіть номера місяця.");
...
let color = prompt("Виберіть колір: червоний, зелений або жовтий").toLowerCase();
...
//Створіть змінні для зберігання двох чисел та оператора (як у списку select). Виконайте відповідну операцію та виведіть результат. 
